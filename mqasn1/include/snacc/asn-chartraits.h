...
#include <cstring> 	// For memmove, memset, memchr
	...
	#include <bits/postypes.h>      // For GCC > 3.4.3 streampos Hovhannes Tumanyan 05/02/2006
#else
...
#elif defined(SunOS) && !(defined(_GLIBCPP_USE_WCHAR_T) || defined(_GLIBCXX_USE_WCHAR_T)) 
